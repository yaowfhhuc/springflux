...
public class DynamicDataSourceRegister
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        mpv.addPropertyValue("dataSource", defaultDataSource);
        registry.registerBeanDefinition("jdbcTemplate", beanDefinition);
        ...
        for (String key : customDataSources.keySet()) {
            ...
            mpv.addPropertyValue("dataSource",customDataSources.get(key));
            registry.registerBeanDefinition(key+"JdbcTemplate", beanDefinition);
        }
    ...
    public DataSource buildDataSource(Map<String, Object> dsMap) {
        try {
            ...
            dsMap.put("type", type);
            dsMap.put("dataSourceType", dataSourceType);
            dataSources.put(String.valueOf(dsMap.get("dsPrefix")), dsMap);
    ...
    private void initCustomDataSources(Environment env) {
        ...
        for (String dsPrefix : dsPrefixs.split(",")) {// 多个数据源
            ...
            Map<String, Object> tMap = new LinkedHashMap<>(dsMap);
            tMap.put("dsPrefix", dsPrefix);
            DataSource ds = buildDataSource(tMap);
